...
img: assets/img/tutoragents_arch.png
importance: 2
category: research
...
<div class="row justify-content-sm-center">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/tutoragents_arch.png" title="System Architecture" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    <strong>The Hybrid Architecture:</strong> A decoupled system featuring a React Frontend, a Spring Boot API Gateway, and a dedicated Python Multi-Agent microservice (SPADE) orchestration layer.
</div>
